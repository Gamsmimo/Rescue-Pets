...
public class Dashboard extends AppCompatActivity {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                    ...
                    switch (menuItem.getItemId()){
                        ...
                        case R.id.nav_perfil:
                            ...
                            actionBar.setTitle("Perfil");//change actionbar title
                        ...
                        case R.id.nav_Publicaciones:
                            ...
                            actionBar.setTitle("Subir Publicaciones");//change actionbar title
    ...
    private void checkUserStatus() {
        ...
        if (user !=null) {
            //el usuario hainiciado sesion permanecer aqui
            //set email of logged in user
            //mPerfilTV.setText(user.getEmail());
        }
        else {
            //el usuario no ha iniciado sesion, vaya a la actividad principal
    ...
    protected void onStart() {
        //verifique el inicio de la aplicacion
        checkUserStatus();
        super.onStart();
